...
Det har även varit intensiva förhandlingar om ål hela natten. Där kan vi konstatera att beslutet blir en utvidgning av antalet månader, men det som vi har lyckats med är att vi har byggt in en flexibilitet kring när man inför det tre extra månadernas fiskestopp. Svensk position har varit att det inte behövs ytterligare månader med fiskestopp utan att det finns andra sätt att värna ålen.  Men utifrån detta beslut kommer vi göra allt för att implementera det på ett bra sätt som möjligt där vi fortsatt värnar ett varsamt svenskt ålfiske.
