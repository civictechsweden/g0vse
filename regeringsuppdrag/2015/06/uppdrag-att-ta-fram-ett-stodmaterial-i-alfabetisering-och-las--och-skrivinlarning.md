# Uppdrag att ta fram ett stödmaterial i alfabetisering och läs- och skrivinlärning

Regeringen ger Statens skolverk i uppdrag att ta fram ett stödmaterial i alfabetisering och läs\- och skrivinlärning som kan vara till stöd och hjälp för de lärare som ska undervisa elever i alfabetisering och läs\- och skrivinlärning inom utbildning i svenska för invandrare (sfi) och svenska som andraspråk inom kommunal vuxenutbildning.


Vid utformandet av stödmaterialet ska hänsyn tas till den utveckling som skett och de nya erfarenheter som gjorts inom det pedagogiska området vad gäller modern teknik.
