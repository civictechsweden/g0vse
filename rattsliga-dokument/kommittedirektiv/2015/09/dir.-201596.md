...
Syftet är att identifiera risker i välfärdssystemen och andra närliggande skattefinansierade eller skattesubven­tionerade system, för att därigenom kunna säkerställa en korrekt användning av offentliga medel samt effektivt förebygga och beivra brottslighet av detta slag.

Utredaren ska bl.a.

* kartlägga den ekonomiska brottslighet som i organiserade och systematiska former begås mot välfärdssystemen och andra närliggande skattefinansierade eller skattesubventionerade system,
* identifiera riskfaktorer i de mest utsatta systemens regelverk, organisation, rutiner och faktiska tillämpning samt föreslå åtgärder som stärker möjligheterna att förebygga och förhindra organiserad och systematisk ekonomisk brottslighet mot välfärden,
...
[Pressmeddelande: Organiserat och systematisk brottslighet mot välfärdssystemen ska stoppas](/pressmeddelanden/2015/09/systematisk-och-organiserad-brottslighet-mot-valfardssystemen-ska-stoppas/)
