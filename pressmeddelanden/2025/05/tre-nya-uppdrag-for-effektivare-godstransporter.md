...
Trafikverket får i uppdrag att ta fram en trafikslagsövergripande handlingsplan för att förbättra förutsättningarna för långväga godstransporter. Fokus ska ligga på transporter som passerar läns- och nationsgränser.
...
Regeringen behöver få ett tydligt underlag kring förekomsten och omfattningen av vissa företeelser inom järnvägens godstransporter. Därför får Trafikanalys i uppdrag att ta fram ett kunskapsunderlag som kan bidra till effektivare godstransporter på järnväg.
...
För att möta näringslivets efterfrågan på att använda tyngre fordon byggs det statliga vägnätet ut för att klara de tyngsta transporterna. Utbyggnaden av ett vägnät för bärighetsklass 4 (BK4 – den högsta bärighetsklassen) pågår och cirka 45 procent av det statliga vägnätet tillhör i dag bärighetsklass 4. Regeringen bedömer att utbyggnaden ska fortsätta även i kommande planperiod så att hela det statliga vägnätet som i dag har bärighetsklass 1 (BK1 - den näst högsta bärighetsklassen) ska nå bärighetsklass 4. Samtidigt påbörjas och avslutas en transport oftast inte på det statliga vägnätet, utan på till exempel kommunal eller enskild väg.
