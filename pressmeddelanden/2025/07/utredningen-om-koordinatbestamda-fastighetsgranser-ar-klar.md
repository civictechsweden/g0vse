# Utredningen om koordinatbestämda fastighetsgränser är klar
...
Utredningen föreslår att gränser för traditionella fastigheter och marksamfälligheter i framtiden ska bestämmas med koordinater. Det ska ske genom att sträckningen av en fastighetsgräns definieras av gränspunkter, vars lägen bestäms med koordinater. På detta sätt kan gränserna redovisas helt digitalt.

Koordinatbestämning av en fastighetsgräns ska enligt förslaget ske när nya fastighetsgränser bildas (fastighetsbildning) samt när det råder oklarhet om hur en gräns går (fastighetsbestämning). Det ska enligt förslaget också införas en ny lantmäteriåtgärd för att koordinatbestämma befintliga och rättsligt klara fastighetsgränser. Åtgärden kan närmast förklaras som om att man ”översätter” en gräns från fysiska gränsmärken till koordinater.

Utredningens förslag kommer nu att analyseras och beredas inom Regeringskansliet.
